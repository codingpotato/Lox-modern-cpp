...
struct Hash_table {
 public:
  ...
  Hash_table(const Hash_table&) noexcept = delete;
  Hash_table(Hash_table&&) noexcept = delete;
  Hash_table& operator=(const Hash_table&) noexcept = delete;
  Hash_table& operator=(Hash_table&&) noexcept = delete;
