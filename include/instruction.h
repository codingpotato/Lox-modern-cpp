...
#define OPCODES(generator)        \
  generator(op_constant, true)    \
  generator(op_nil, false)        \
  generator(op_true, false)       \
  generator(op_false, false)      \
  generator(op_equal, false)      \
  generator(op_greater, false)    \
  generator(op_less, false)       \
  generator(op_add, false)        \
  generator(op_subtract, false)   \
